...
export function FloatingCompareBar() {
  ...
  return (
    <div className="animate-fade-rise fixed bottom-20 left-1/2 z-50 flex w-[calc(100%-2rem)] max-w-lg -translate-x-1/2 flex-wrap items-center gap-2 rounded-card border border-slate-200 bg-surface px-3 py-2.5 shadow-card-hover sm:flex-nowrap sm:gap-3 sm:px-4 sm:py-3 md:bottom-6">
      {/* Thumbnails */}
      ...
      <div className="ml-auto sm:ml-0">
        {count >= 2 ? (
          <Link
            href={href}
            className="inline-flex items-center gap-1.5 rounded-pill bg-accent px-4 py-2 text-sm font-semibold text-white shadow-accent-button transition-colors hover:bg-accent-dark"
          >
